# com-chilipeppr-workspace-test
A ChiliPeppr Workspace test.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / test
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-test |
| Name                  | Workspace / test |
| Description           | A ChiliPeppr Workspace test. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/arthoog/workspace-test/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/arthoog/chilipeppr-test |
| Github URL            | http://github.com/arthoog/workspace-test |
| Test URL              | https://preview.c9users.io/arthoog/chilipeppr-test/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/arthoog/workspace-test/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-test"], // the id you gave your workspace
      function(myWorkspaceTest) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / test just got loaded.", myWorkspaceTest);
        myWorkspaceTest.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-test"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / test"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace test."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/arthoog/workspace-test/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/arthoog/chilipeppr-test"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/arthoog/workspace-test"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://chilipeppr-test-arthoog.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
